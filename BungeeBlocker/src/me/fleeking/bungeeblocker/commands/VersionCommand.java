            ...
            switch (args.length) {
                case 0: {
                    if (sender instanceof ProxiedPlayer) {
                        ...
                        Map<String, String> replacements = LanguageManager.createReplacements(senderName, serverName, String.valueOf(senderVersion));
                        ...
                        Map<String, String> replacements = LanguageManager.createReplacements(targetName, serverName, String.valueOf(targetVersion));
                        String message = LanguageManager.formatMessage("version-of-player", 0, replacements);
                        sender.sendMessage(TextComponent.fromLegacyText(ChatColor.translateAlternateColorCodes('&', message)));
                    }
                    break;
